package com.veltpvp.nirvana.bukkit.game.chest;

import com.veltpvp.nirvana.bukkit.game.chest.content.ConfigurableGameChestContent;
import com.veltpvp.nirvana.bukkit.game.chest.content.GameChestContent;
...
public enum GameChest {
    BASIC(0, new ConfigurableGameChestContent(), 4, 8),
    BUFFED(1, new ConfigurableGameChestContent(), 4, 8),
    OP(2, new ConfigurableGameChestContent(), 4, 8);
