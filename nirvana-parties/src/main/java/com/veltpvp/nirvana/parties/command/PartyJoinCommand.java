...
import com.veltpvp.nirvana.packet.party.PartyJoinPacket;
...
public class PartyJoinCommand extends BasePartyCommand {

    @Command(name = "party.join", aliases = {"p.join", "t.join", "team.join"})
    public void onCommand(CommandArgs command) {
        ...
        main.getNetwork().sendPacket(new PartyJoinPacket(new PartyMember(player.getName(), player.getUniqueId()), entry.getKey(), entry.getValue()), NirvanaChannels.APPLICATION_CHANNEL, RabbitNetworkDeliveryType.DIRECT, new PacketResponseHandler() {
