...
import com.veltpvp.nirvana.packet.party.PartyKickPacket;
...
public class PartyKickCommand extends BasePartyCommand {

    @Command(name = "party.kick", aliases = {"p.kick", "t.kick", "team.kick"})
    public void onCommand(CommandArgs command) {
        ...
        main.getNetwork().sendPacket(new PartyKickPacket(new PartyMember(player.getName(), player.getUniqueId()), entry.getKey(), entry.getValue()), NirvanaChannels.APPLICATION_CHANNEL, RabbitNetworkDeliveryType.DIRECT, new PacketResponseHandler() {
